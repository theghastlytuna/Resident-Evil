...
unsigned Scene::CreateFloor(std::string fileName, int spriteX, int spriteY, float posX, float posY, float shrinkX, float shrinkY, float angle)
{
	//Creates entity
	auto entity = ECS::CreateEntity();
	...
	//Sets up components
	ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, spriteX, spriteY);
	ECS::GetComponent<Transform>(entity).SetPosition(vec3(posX, posY, 0.f));
	...
	tempPhsBody = PhysicsBody(entity, tempBody, float(tempSpr.GetWidth() - shrinkX),
		float(tempSpr.GetHeight() - shrinkY), vec2(0.f, 0.f), false, GROUND, OBJECTS);
	tempPhsBody.SetColor(vec4(0.f, 1.f, 0.f, 0.3f));
...
unsigned Scene::CreateWalls(std::string fileName, int spriteX, int spriteY, float posX, float posY, float shrinkX, float shrinkY, float angle)
{
	//Creates entity
	auto entity = ECS::CreateEntity();
	...
	tempPhsBody = PhysicsBody(entity, tempBody, float(tempSpr.GetWidth() - shrinkX),
		float(tempSpr.GetHeight() - shrinkY), vec2(0.f, 0.f), false, GROUND, PLAYER | ENEMY | OBJECTS | FRIENDLY);
	tempPhsBody.SetColor(vec4(0.f, 1.f, 0.f, 0.3f));
...
unsigned Scene::CreateObstacles(std::string fileName, int spriteX, int spriteY, float posX, float posY, float shrinkX, float shrinkY, float angle)
{
	//Creates entity
	auto entity = ECS::CreateEntity();
